...
model_path = '/home/zzw/code/NWPU-MOC-main/exp/08-02_23-37_MOC_RS_MCC_loss_FocalL2_loss_alpha_1_base_lr_5e-05_NIR=False/all_ep_161_cls_avg_mae_4.4_cls_avg_mse_10.3_cls_weight_mse_48.1.pth'
        ...
        with torch.set_grad_enabled(False):
            if pos_embedding:
                ...
                for i in range(0, h, rh):
                    ...
                    for j in range(0, w, rw):
                        gjs, gje = max(min(w-rw, j), 0), min(w, j+rw)
                        pred_map[:, :, gis:gie, gjs:gje] = pred_map[:, :, gis:gie, gjs:gje] + crop_preds[idx]
                        idx = idx + 1
            ...
            for c_idx in range(len(categorys)):
                ...
                wmse = wmse + square_errors[c_idx] * weights[c_idx]
