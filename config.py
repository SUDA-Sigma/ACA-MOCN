...
# __C.LOSS_FUNCTION = 'Cos_loss'
__C.LOSS_FUNCTION = 'FocalL2_loss'
...
# __C.PRE_WEIGHTS = '/HOME/scz0o01/run/zzw/data/swin_base_patch4_window7_224.pth'
__C.PRE_WEIGHTS = '/home/zzw/data/pretrain/swin_base_patch4_window7_224.pth'
